...
import com.biz.grade.serivce.ScoreSerivceiceimp_02;
...
public class ScoreExec_01 {
	...
	public static void main(String[] args) {
		...
		ScoreSerivce sService =new ScoreSerivceiceimp_02(); // 10개의 고정된 배열
		//sService= new ScoreSerivceiceimp_03(arrLen); //30개의 지정한 배열 
